(function (global, factory) {
    ...
    class Entity {
        constructor() {
            this.sprite = new GWU__namespace.sprite.Sprite();
    ...
    class EmitEffect {
        ...
        async fire(config, _map, x, y, ctx) {
            if (config.emit) {
                return await GWU__namespace.events.emit(config.emit, x, y, ctx);
            }
            return false;
        }
        fireSync(config, _map, _x, _y, _ctx) {
    ...
    class Map {
        constructor(width, height, opts = {}) {
            ...
            this.flags = { map: 0 };
            this.layers = [];
            this.cells = GWU__namespace.grid.make(width, height, () => new Cell());
            this.memory = GWU__namespace.grid.make(width, height, () => new CellMemory());
    ...
    exports.entity = index$5;
    exports.flags = index$6;
